# Interview Preparation Guide — Codex Context
...
- `15-cs-fundamentals/` (operating-systems, networking, linux-shell, cryptography), `16-testing/` (testing, api-testing), `17-languages/` (python, go) — added 2026-06-30
...
- Memory index: `C:\Users\prash\.Codex\projects\C--Learning-interview-preparation\memory\MEMORY.md`.
